...
$enableSearch=in_array(\core\Route::getCurrentRequestLabel(),[SERVICE_REQUESTS_ENDPOINT_LABEL,SERVICES_ENDPOINT_LABEL,CATEGORIES_ENDPOINT_LABEL]);
?>
